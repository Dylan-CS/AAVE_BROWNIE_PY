...
def main():
    ...
    account = get_account()
    # get the address of smart contract of the erc20 token 
    ...
    if network.show_active() in ["goerli"]:
         dai_eth_price = get_asset_price(config["networks"][network.show_active()]["dai_usd_price_feed"])/get_asset_price(config["networks"][network.show_active()]["eth_usd_price_feed"])
